...
- **[docs/THEORY.md](docs/THEORY.md)** — 窄门理论体系v1.0（九章完整方法学）
  - 核心命题 + 灵魂审计方法论 + 进化金字塔 + 30天穿越训练 + 大师引导者 + 见证人网络
- **[docs/KNOWLEDGE_BASE.md](docs/KNOWLEDGE_BASE.md)** — 知识库（22个理论框架+推荐阅读）
