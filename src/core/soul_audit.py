...
AUDIT_DIMENSIONS = {
    ...
    "幻觉": {
        "description": "你活在哪些人类幻觉中？（源自《与神对话》十大幻觉）",
        "surface_questions": [
            "你觉得生活中什么是你必须拥有的？没有它会怎样？",
            "你是否认为自己是某些情况的受害者？具体是什么？",
            "你觉得你和别人是分离的还是有连接的？",
            "你是否觉得不够——钱不够、时间不够、能力不够？",
            "你是否在用别人的标准来审判自己？",
        ],
    ...
    "幻觉": {
        "description": "你活在哪些人类幻觉中？（源自《与神对话》十大幻觉）",
        "surface_questions": [
            "你觉得生活中什么是你'必须拥有'的？没有它会怎样？",
            "你是否认为自己是某些情况的'受害者'？具体是什么？",
            "你觉得你和别人是分离的还是有连接的？",
            "你是否觉得'不够'——钱不够、时间不够、能力不够？",
            "你是否在用别人的标准来审判自己？",
        ],
        "evasion_patterns": ["这是人之常情", "大家都这样想", "这是现实不是幻觉"],
    }
