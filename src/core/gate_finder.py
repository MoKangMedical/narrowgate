...
GATE_TEMPLATES = {
    ...
    "宇宙认知": {
        "意义逃避": {
            "description": "你用怀疑宏大问题来回避真正的存在性选择",
            "wide_gate": "把意义问题归为玄学、哲学或无用思考，继续按惯性生活",
            "narrow_gate": "写下你此生真正要服务的东西，并用一个具体行动验证它",
            "indicators": ["能说清自己的终极关切", "连续30天为它行动", "不再用虚无感逃避责任"],
            "daily_challenge": "今天做一件只对你的长期意义负责、短期没有回报的事",
        },
        "命运旁观": {
            "description": "你把人生交给命运、环境或系统，从而回避自己的选择权",
            "wide_gate": "相信一切早已决定，因此不用承担选择后的代价",
            "narrow_gate": "承认你仍有一小块选择权，并立刻为它付出行动成本",
            "indicators": ["能指出自己可控的一步", "主动承担一次选择后果", "停止把停滞解释成命运安排"],
            "daily_challenge": "今天选一件你一直说'没办法'的事，找出并执行一个可控动作",
        },
    },
}
